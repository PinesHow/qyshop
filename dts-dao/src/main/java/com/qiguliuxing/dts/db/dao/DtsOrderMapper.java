...
import com.qiguliuxing.dts.db.domain.DtsLogisticsResult;
import com.qiguliuxing.dts.db.domain.DtsOrder;
import com.qiguliuxing.dts.db.domain.DtsOrderExample;
import com.qiguliuxing.dts.db.domain.DtsRefundTrace;
...
public interface DtsOrderMapper {
    ...
    int createRefundTrace(DtsRefundTrace dtsRefundTrace);

    int updateRefundTraceByOrderId(DtsRefundTrace dtsRefundTrace);

    DtsRefundTrace findRefundTraceByOrderId(@Param("orderId") Integer orderId);

    DtsOrder findByPayId(@Param("payId") String transactionId);

    List<DtsOrder> selectOrderByShopId(@Param("shopId") Integer shopId,@Param("orderStatus") Short orderStatus);

    DtsLogisticsResult selectLogisticsResultByOrderId(@Param("orderId") Integer orderId);

    int addLogistics(DtsLogisticsResult dtsLogisticsResult);

    int updateLogistics(DtsLogisticsResult dtsLogisticsResult);
