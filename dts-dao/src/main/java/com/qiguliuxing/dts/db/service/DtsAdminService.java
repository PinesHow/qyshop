...
public class DtsAdminService {
	...
	public List<DtsAdmin> querySelective(String username, Integer page, Integer limit, String sort, String order,Integer shopId) {
		DtsAdminExample example = new DtsAdminExample();
		...
		criteria.andDeletedEqualTo(false).andShopIdEqualTo(shopId);
