...
public class DtsCartService {
	...
	public DtsCart queryExist(Integer goodsId, Integer productId, Integer userId) {
		...
		DtsCartExample.Criteria or = example.or();
		or.andGoodsIdEqualTo(goodsId).andProductIdEqualTo(productId).andUserIdEqualTo(userId)
...
//		cartMapper.logicalDeleteByPrimaryKey(id);
	...
	public int updateCheckedFalseByGoodsId(Integer goodsId) {
		return cartMapper.updateCheckedFalseByGoodsId(goodsId);
	}
}
