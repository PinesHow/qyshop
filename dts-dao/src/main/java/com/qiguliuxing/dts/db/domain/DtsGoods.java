...
public class DtsGoods {
    ...
    public void setIsShopConsumption(Boolean shopConsumption) {
        isShopConsumption = shopConsumption;
    }
    ...
    public enum Column {
        ...
        shopCategoryId("shop_category_id", "shopCategoryId", "INTEGER", false),
        shopType("shop_type","shopType","INTEGER",false),
        tripDesc("trip_desc","tripDesc","VARCHAR",false),
        costDesc("cost_desc","costDesc","VARCHAR",false),
        destination("destination","destination","VARCHAR",false),
        latitudeAndLongitude("latitude_and_longitude","latitudeAndLongitude","VARCHAR",false),
