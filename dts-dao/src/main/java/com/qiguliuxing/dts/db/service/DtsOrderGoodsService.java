...
public class DtsOrderGoodsService {
	...
	public List<Integer> selectShopTypeByOrderId(Integer id) {
		return orderGoodsMapper.selectShopTypeByOrderId(id);
	}

	public List<DtsOrderGoods> selectOderGoodsByShopId(Integer shopId) {
		return orderGoodsMapper.selectOderGoodsByShopId(shopId);
	}
}
