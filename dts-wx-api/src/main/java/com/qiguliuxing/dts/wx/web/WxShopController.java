...
//        logger.info("【请求结束】访问店铺首页,响应结果,优惠券信息：{}", JSONObject.toJSONString(data.get("couponList")));
    ...
    public Object selectShopList(@LoginUser Integer userId,@RequestParam("categoryId") Integer categoryId,@RequestParam(defaultValue = "0") Integer page,@RequestParam(defaultValue = "10") Integer limit){
        logger.info("【请求开始】访问商铺列表，请求参数,categoryId:{},page:{},limit:{}",categoryId,page,limit);
        ...
        logger.info("【请求结束】访问商铺列表成功,响应结果,商铺列表信息：{}", JSONObject.toJSONString(map.get("dtsShopList")));
    ...
    public Object selectGoodsList(@LoginUser Integer userId,@RequestParam("shopCategoryId") Integer categoryId,@RequestParam(defaultValue = "1") Integer page,@RequestParam(defaultValue = "10") Integer limit,@RequestParam("shopId") Integer shopId){
    ...
    public Object selectOrderListByShop(@LoginUser Integer userId){
        ...
        if(StringUtils.isEmpty(dtsUser)){
            return ResponseUtil.fail(500,"用户未登录,请登录!");
        }
        String mobile = dtsUser.getMobile();//用户电话
        if(StringUtils.isEmpty(mobile)){
            return ResponseUtil.fail(500,"用户未绑定手机,请绑定!");
        }
