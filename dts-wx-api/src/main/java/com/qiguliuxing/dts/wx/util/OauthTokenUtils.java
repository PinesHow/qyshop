...
//    private static String appSecret = "6f688c3eb18cb8430a5b0d6cf43497a4";
     ...
     * 测试环境 李
     */
//    private static String appId = "wx0b95f3d246d590e5";
//    private static String appSecret = "4dcb281396c5bdce2a9e4c9a726a0723";
    /**
     * 线上环境
     */
...
//			inputStream = null;
     ...
     * @throws IOException
     */
    public static String oauthToken(String code,String appId,String appSecret) throws IOException {
        URL url = new URL(URL + "/sns/oauth2/access_token?appid="+appId+"&secret="+appSecret+"&code="+code+"&grant_type=authorization_code");
        //发送并把结果赋给result
    ...
    public static String getUserInfo(String accessToken, String openId) throws IOException{
        URL url = new URL(URL + "/sns/userinfo?access_token="+accessToken+"&openid="+openId+"&lang=zh_CN");
        //发送并把结果赋给result
        String result= getToken(url);
        return result;
    }
