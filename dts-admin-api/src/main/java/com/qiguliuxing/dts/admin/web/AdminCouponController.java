...
public class AdminCouponController {
	...
	@RequiresPermissionsDesc(menu = { "店铺管理", "优惠券管理" }, button = "查找")
	@GetMapping("/list")
	public Object list(String name, Short type, Short status,@RequestParam Integer shopId, @RequestParam(defaultValue = "1") Integer page,
			@RequestParam(defaultValue = "10") Integer limit,
			@Sort @RequestParam(defaultValue = "add_time") String sort,
			@Order @RequestParam(defaultValue = "desc") String order) {
		logger.info("【请求开始】推广管理->优惠券管理->查询,请求参数:name:{},page:{}", name, page);

		List<DtsCoupon> couponList = couponService.querySelective(name, shopId, type, status, page, limit, sort, order);
	...
	@RequiresPermissionsDesc(menu = { "店铺管理", "优惠券管理" }, button = "查询用户")
	@GetMapping("/listuser")
	...
	@RequiresPermissionsDesc(menu = { "店铺管理", "优惠券管理" }, button = "添加")
	@PostMapping("/create")
	...
	@RequiresPermissionsDesc(menu = { "店铺管理", "优惠券管理" }, button = "详情")
	@GetMapping("/read")
	...
	@RequiresPermissionsDesc(menu = { "店铺管理", "优惠券管理" }, button = "编辑")
	@PostMapping("/update")
	...
	@RequiresPermissionsDesc(menu = { "店铺管理", "优惠券管理" }, button = "删除")
	@PostMapping("/delete")
