...
public class WxOrderController {
	...
	public Object list(@LoginUser Integer userId, @RequestParam(defaultValue = "0") Integer showType,
		...
		logger.info("【请求开始】订单列表,请求参数,userId:{},showType:{},page:{},size:{}", userId, showType, page,size);
	...
	/**
	 * 核销订单商品 1.校验该订单是否属于当前商家 2.修改订单状态(已收货状态)
	 * @param body
	 * @return
	 */
	@PostMapping("/destruction")
	public Object destructionOrder(@RequestBody String body){
		logger.info("【请求开始】商品管理->订单管理->订单核销,请求参数,dtsLogisticsTracking:{}", body);
		return wxOrderService.destructionOrder(body);
	}
